...
const defaultCampaigns: Campaign[] = [
  {
    ...
    goalAmount: 50000,
    raisedAmount: 32500,
    medicalCondition: "Acceso a agua limpia",
    hospitalName: "Cruz Roja Mexicana",
  ...
  },
  {
    ...
    goalAmount: 25000,
    raisedAmount: 18750,
    medicalCondition: "Leucemia linfoblástica aguda",
    hospitalName: "Hospital Infantil de México",
    medicalDocDescription: "Diagnóstico confirmado por oncología pediátrica",
    walletAddress: "GAIH3ULLFQ4DGSECF2AR555KZ4KNDGEKN4AFI4SU2M7B43MGK3QJZNSR",
    verified: true,
    trustScore: 92,
    daysLeft: 15,
  ...
  },
  {
    ...
    goalAmount: 80000,
    raisedAmount: 45000,
    medicalCondition: "Estenosis aórtica severa",
    hospitalName: "Hospital Civil de Guadalajara",
    medicalDocDescription: "Ecocardiograma y valoración cardiológica",
    walletAddress: "GAIH3ULLFQ4DGSECF2AR555KZ4KNDGEKN4AFI4SU2M7B43MGK3QJZNSR",
    verified: true,
    trustScore: 88,
    daysLeft: 30,
  ...
  },
  {
    ...
    goalAmount: 35000,
    raisedAmount: 12300,
    medicalCondition: "Fractura múltiple de fémur",
    hospitalName: "Hospital Universitario de Monterrey",
    medicalDocDescription: "Radiografías y plan de rehabilitación",
    walletAddress: "GAIH3ULLFQ4DGSECF2AR555KZ4KNDGEKN4AFI4SU2M7B43MGK3QJZNSR",
    verified: true,
    trustScore: 90,
    daysLeft: 45,
  ...
  },
  {
    ...
    goalAmount: 15000,
    raisedAmount: 8500,
    medicalCondition: "Diabetes mellitus tipo 1",
    hospitalName: "Hospital General de Puebla",
    medicalDocDescription: "Estudios de laboratorio y diagnóstico endocrinológico",
    walletAddress: "GAIH3ULLFQ4DGSECF2AR555KZ4KNDGEKN4AFI4SU2M7B43MGK3QJZNSR",
    verified: true,
    trustScore: 94,
    daysLeft: 20,
  ...
  },
  {
    ...
    goalAmount: 60000,
    raisedAmount: 28000,
    medicalCondition: "Malformación facial congénita",
    hospitalName: "Hospital General de Tijuana",
    medicalDocDescription: "Evaluación por cirugía maxilofacial",
    walletAddress: "GAIH3ULLFQ4DGSECF2AR555KZ4KNDGEKN4AFI4SU2M7B43MGK3QJZNSR",
    verified: true,
    trustScore: 86,
    daysLeft: 35,
...
export function CampaignProvider({ children }: { children: React.ReactNode }) {
  ...
  const getTotalDonatedByUser = useCallback((address: string) => {
    return donations
      ...
      .reduce((sum, d) => sum + d.amountMXN, 0);
  }, [donations]);
